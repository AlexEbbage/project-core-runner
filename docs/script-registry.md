...
| `MainMenuUI.cs` | `Assets/Scripts/UI/MainMenu` | UI | Play-page presentation, best score, lock-aware level selection, level-up feedback, side-entry routing for tasks/daily login, remove-ads entry points, and level/progression analytics hooks | GameManager, level selection data, monetisation UI, progression surfaces | F7, F8, F10, F11, F12, F14, F15, F18 | Active |
