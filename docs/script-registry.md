...
| `BoosterData.cs` | `Assets/Scripts/UI/MainMenu` | UI | Booster catalog and booster definition data used by the pre-run selection surface and run-scoped modifiers | PlayerProfile, main menu selection UI, game flow | F20 | Active |
