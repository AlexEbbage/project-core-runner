...
| `TunnelWallGeneratorV2.cs` | `Assets/CoreRacer/Runtime/Gameplay/Environment` | Gameplay | Generates the selected polygon tunnel mesh and recenters it ahead of the player without regenerating the authored hierarchy | `RunController`, player transform, route side count, tunnel renderer/material | F1, F12 | Active |
