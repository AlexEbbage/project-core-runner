...
- Unity MCP live result: three options rendered; Start Shield, Coin Boost, and Score Boost applied to a DECAGON run; Home restored score and coin multipliers to x1 with `Time.timeScale` at 1.
